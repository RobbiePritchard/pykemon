...
class Battle(object):
	...
	def __init__(self,pokemon1,pokemon2):
		...
		while pokemon1.currentHP > 0 and pokemon2.currentHP > 0:
			self.choose_attack(pokemon1)
			self.damage_delt(pokemon1, self.attacker_move, pokemon2)
			self.choose_attack(pokemon2)
			self.damage_delt(pokemon2, self.attacker_move, pokemon1)
			print()
			print(pokemon1)
			print(pokemon2)
		if pokemon1.currentHP == 0:
			pokemon1.given_ev([pokemon2])
			pokemon2.experience += pokemon1.exp_gain_formula()
		else:
			pokemon2.given_ev([pokemon1])
			pokemon1.experience += pokemon2.exp_gain_formula()
		print(pokemon1)
		print(pokemon2)
